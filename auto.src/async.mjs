...
async function findNearestFileAsync(config_file_name, dir_path) {
	...
	return await findNearestFileAsync(config_file_name, parent_dir_path)
}

export default findNearestFileAsync
